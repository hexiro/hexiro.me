...
export const TagIcon: IconType = (props) => (
...
export const IMDbIcon: IconType = (props) => (
    // 'IMDb' icon from simple-icons
    <SimpleIcon {...props}>
        <title>IMDb</title>
...
export const SpotifyIcon: IconType = (props) => (
    // 'brand-spotify' icon from tabler-icons
    <Icon {...props}>
...
export const SteamIcon: IconType = (props) => (
    // 'brand-steam' icon from tabler-icons
    <Icon {...props}>
...
export const EpicGamesIcon: IconType = (props) => (
    // 'Epic Games' from simple icons
    <SimpleIcon {...props}>
...
export const LastFmIcon: IconType = (props) => (
    // 'brand-lastfm' icon from tabler-icons
    <Icon {...props}>
