...
const Icon = (props: IconProps) => <StyledSVG stroke fill={false} viewBox="0 0 24 24" {...props} />;
const SimpleIcon = (props: IconProps) => (
    <StyledSVG fill stroke={false} viewBox="0 0 24 24" {...props} />
);
